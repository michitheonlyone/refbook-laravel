                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item d-block d-lg-none">
                            <a href="{{ url($category->slug) }}" class="nav-link border-bottom">
                                {{-- if active bg-muted --}}
                                {{ $category->name }}
                            </a>
                        </li>
                    ...
                    <div class="card">
                        ...
                        <div class="list-group list-small">
                            ...
                            <a href="{{ url($category->slug) }}"
                                class="list-group-item d-flex justify-content-between align-items-center list-group-item-action">{{-- if active bg-muted --}}
                                {{ $category->name }}
